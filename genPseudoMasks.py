...
def generate_voc_proposas(args):
    ...
    if args.model_type == 'vgg16':
        ...
        seg_model = MSC(base=DeepLabV2_Resnet101(layers=101, num_classes=CONFIG.DATASET.N_CLASSES, pretrained=True),
            scales=[0.5, 0.75],
        )
    ...
    labelSavePath = os.path.join(args.voc_proposals_dir_path, args.model_type + '_Round' + str(args.round)）
...
if __name__ == "__main__":
    ...
    parser.add_argument('--coco_root_dir_path', default='/home/vious/data/cocoDataset/', help='')
    ...
    parser.add_argument('--voc_proposals_dir_path', default='./exp/pseudo_labels/', help='')

    # for generate coco proposals
    parser.add_argument('--init_coco_model_path', default='', help='')
    parser.add_argument('--coco_proposals_dir_path', default='./exp/coco/', help='')
